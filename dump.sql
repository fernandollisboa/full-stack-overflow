...
COPY public.questions (id, question, student_name, class, tags, "submitAt", answered, "answeredAt", "answeredBy", answer) FROM stdin;
\.
...
ALTER TABLE ONLY public.questions
    ADD CONSTRAINT questions_fk0 FOREIGN KEY (student_name) REFERENCES public.users(name);
...
ALTER TABLE ONLY public.questions
    ADD CONSTRAINT questions_fk1 FOREIGN KEY ("answeredBy") REFERENCES public.users(name);
